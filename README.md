...
Using the repository is straightforward - all you need to do is run the `train.py` script with different arguments, depending on the model and training parameters you'd like to use.
